...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-tent/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-tent -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-tent -o bitcore-lib-tent.js';
    }
